      ...
      >
        ...
        {activeIndex === 0 && (
          <TabContainer>
            ...
            <Button
              variant="contained"
              size="small"
              href="https://forms.gle/KeCxkhS9jhowm6yJ9"
            >
              Mock Test
            </Button>{" "}
          </TabContainer>
        ...
        {activeIndex === 1 && (
          <TabContainer>
            ...
            get basic skill in cloud data services , and build your foundational
            knowledge of cloud data services within Microsoft Azure . You will
            identify and describe core data concepts such as relational ,
            non-relational, big data , and analytics .<br />
            <br />
            <Button
              variant="contained"
              size="small"
            ...
            <Button
              variant="contained"
              size="small"
              href="https://forms.gle/VmvzVC7Nartgd46F9"
            >
              Mock Test
            </Button>
          </TabContainer>
        ...
        {activeIndex === 2 && (
          <TabContainer>
            ...
            Learn about the core concepts , principles ,and methodologies that
            are foundational to security , complaince , and identity solutions
            ...
            <Button
              variant="contained"
              size="small"
              href="https://forms.gle/R7HYbsHbxFLRSNcn6"
            >
              Mock Test
            </Button>
          </TabContainer>
